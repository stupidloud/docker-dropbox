...
RUN apt update && apt install -y libglib2.0-0 libglapi-mesa libxext6 libxdamage1 libxcb-glx0 libxcb-dri2-0 libxcb-dri3-0 libxcb-present0 libxcb-sync1 libxshmfence1 libxxf86vm1 wget
